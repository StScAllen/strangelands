...
func showAttributesMinutiae() {
	...
	for flag {
		...
		fmt.Println("")
		fmt.Println("Score	Modifiers")
		fmt.Println(" 1 	Actions: 2		Defense: -2")
		fmt.Println(" 2 	Actions: 3 		Defense: -1")
		fmt.Println(" 3 	Actions: 4 		Defense: -1")
		fmt.Println(" 4 	Actions: 5 		Defense: 0")
		fmt.Println(" 5 	Actions: 6 		Defense: 0")
		fmt.Println(" 6 	Actions: 7 		Defense: +1")
		fmt.Println(" 7 	Actions: 8 		Defense: +1")
		fmt.Println(" 8 	Actions: 9 		Defense: +2")
		fmt.Println(" 9 	Actions: 10 	Defense: +2")
		fmt.Println(" 10 	Actions: 12 	Defense: +3")
		fmt.Println("")
		fmt.Println("[ENTER] to continue.")
		fmt.Scanln(&rsp)
